...
average_size_diff = Constant(160.1e-2)

rhos = Constant(2650/1000)
rhos_diff = Constant(2651/1000)

diffusivity = Constant(0.15*10)
diffusivity_diff = Constant(1.5 + 10**(-3))
...
reg_param_diff = 5e-5
print(reg_param)
identity = Function(V).interpolate(Constant(1.0))
reg_form = reg_param*(average_size*average_size*identity)
